...
export const ADMIN_ACTIONS = {
  ...
  NOTIFICATION_TEMPLATE_CREATE: 'ADMIN_NOTIFICATION_TEMPLATE_CREATE',
  NOTIFICATION_TEMPLATE_UPDATE: 'ADMIN_NOTIFICATION_TEMPLATE_UPDATE',
  NOTIFICATION_TEMPLATE_DELETE: 'ADMIN_NOTIFICATION_TEMPLATE_DELETE',
