...
import api, { saveTokens } from '@cropsetu/shared/services/api';
...
export default function BusinessProfileScreen({ navigation }) {
  ...
  function flashSavedToast() {
    ...
    Animated.sequence([
      ...
      // the save has just flipped the role to SELLER — so open the dashboard and
      // drop the KYC form from the stack.
