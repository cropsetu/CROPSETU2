...
// Read from the host app's manifest rather than importing its app.json — this
// module is shared by the buyer and seller apps, which have separate manifests.
const APP_VERSION = Constants.expoConfig?.version || 'unknown';
const APP_SLUG    = Constants.expoConfig?.slug || 'unknown';
